...
class EVPZWrapper(gym.Env):
    ...
    def get_avail_agent_actions(self, agent_id):
        ...
        # 获取agent的ID
        agent = self._env.possible_agents[agent_id]#possible_agents
        # 直接返回底层环境中的可用动作索引列表
...
gym.register(
    "test-parallel-v6",
    entry_point="envs.test_wrapper:EVPZWrapper",
    kwargs={
        "net_file": "src/dataset/jumbo/jumbo.net.xml",
        "sim_file": "src/dataset/jumbo/jumbo.sumocfg",
        "rou_file": "src/dataset/jumbo/jumbo.rou.xml",
        "add_file": "src/dataset/jumbo/jumbo.cs.add.xml",
        ...
        # "rou_file": "src/dataset/4_station_strip/4_station_strip_ev.rou.xml",
        # "add_file": "src/dataset/4_station_strip/4_station_strip.cs.add.xml",
        # "net_file": "src/dataset/berlin/berlin.net.xml",
        # "sim_file": "src/dataset/berlin/berlin.sumocfg",
        # "rou_file": "src/dataset/berlin/berlin_ev0.rou.xml",
        # "add_file": "src/dataset/berlin/berlin.cs.add.xml",        
        "begin_time": 0,
        "time_limit": 200,
        "enable_gui": False,
        "sumo_seed": "1",
        ...
        "output_file": "src/results/transmix_results"
